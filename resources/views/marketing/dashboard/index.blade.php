        ...
        <header class="header header-sticky p-0 mb-4">
            <div class="container-fluid border-bottom px-4">
                ...
                <ul class="header-nav d-none d-lg-flex">
                    <li class="nav-item"><a class="nav-link" href="{{ route('marketing') }}">Dashboard</a></li>
                </ul>
                ...
                <ul class="header-nav">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown"
                            ...
                            <div class="avatar avatar-md"><i
                                class="avatar-img bi bi-person-circle" 
                                src="assets/img/avatars/8.jpg"
                                    alt="{{ auth()->user()->name }}"></i></div>
                        </a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="border-start border-start-4 border-start-danger px-3 mb-3">
                                                    <div class="small text-body-secondary text-truncate">Recuring Clients
                                                    </div>
