                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <label for="order_date" class="fw-bold form-label d-block">Alamat Customer : </label>
                                            <label for="order_date"
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="mb-3">
                                            <label for="order_date" class="fw-bold form-label d-block">Tanggal Pesanan Dibuat :
                                            </label>
                                            <label for="order_date" class="form-label">
                                        ...
                                        <div class="mb-3">
                                            <label for="order_date" class="fw-bold form-label d-block">Tanggal Pesanan Diupdate :
                                            </label>
                                            <label for="order_date" class="form-label">
                                        ...
                                        <div class="mb-3">
                                            <label for="order_date" class="fw-bold form-label d-block">Total Berat Produk Yang Dipesan :
                                            </label>
                                            <label for="order_date" class="form-label">
                                                {{ $totalWeight }} KG
                                            </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a href="{{ route('order.edit', $order->id) }}" class="btn btn-primary ms-2">Edit
                                                Pesanan</a>
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    price.forEach((element, index) => {
                        ...
                        subtotal[index].textContent = parseInt(subtotal[index].textContent).toLocaleString('id-ID', {
                            style: 'currency',
                            currency: 'IDR'
                        });
                    });
