        ...
        <div class="body flex-grow-1">
            <div class="container-lg px-4">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">Tambah Pesanan Customer</div>
                            <div class="card-body">
                                        ...
                                        <select class="form-control " id="transporter" name="transporter"
                                            ...
                                            @foreach ($transporters as $transporter)
                                                <option value="{{ $transporter->id }}"
                                                    {{ old('transporter') == $transporter->id ? 'selected' : '' }}
...
@section('scripts')
    ...
    <script>
        ...
        const orderNumberValue = `${year}${month}${day}${hours}${milliseconds}`;
        orderNumber.value = 'ODN' + orderNumberValue;
    </script>
@endsection
