                                ...
                                <form action="{{ route('armada.update', $armada->id) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"
                                            value="{{ old('name') ? old('name') : $armada->name }}" required>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="type" name="type" data-allow-clear="true"
                                            ...
                                            <option value="Tronton" {{ old('type') ? (old('type') == 'Tronton' ? 'selected' : '') : ($armada->type == 'Tronton' ? 'selected' : '') }}>Tronton</option>
                                            <option value="Gandeng" {{ old('type') ? (old('type') == 'Gandeng' ? 'selected' : '') : ($armada->type == 'Gandeng' ? 'selected' : '') }}>Gandeng</option>
                                            <option value="Engkel" {{ old('type') ? (old('type') == 'Engkel' ? 'selected' : '') : ($armada->type == 'Engkel' ? 'selected' : '') }}>Engkel</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="brand" class="form-label">Merk Kendaraan</label>
                                        <input type="text" class="form-control" id="brand" name="brand"
                                            value="{{ old('brand') ? old('brand') : $armada->brand }}" required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="year" class="form-label">Tahun Pembuatan</label>
                                        <input type="number" class="form-control" id="year" name="year" min="1900"
                                            value="{{ old('year') ? old('year') : $armada->year }}" required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="condition" name="condition" data-allow-clear="true"
                                            ...
                                            <option value="Baik" {{ old('condition') ? (old('condition') == 'Baik' ? 'selected' : '') : ($armada->condition == 'Baik' ? 'selected' : '') }}>Baik</option>
                                            <option value="Rusak" {{ old('condition') ? (old('condition') == 'Rusak' ? 'selected' : '') : ($armada->condition == 'Rusak' ? 'selected' : '') }}>Rusak</option>
                                            <option value="Sedang diperbaiki" {{ old('condition') ? (old('condition') == 'Sedang diperbaiki' ? 'selected' : '') : ($armada->condition == 'Sedang diperbaiki' ? 'selected' : '') }}>Sedang diperbaiki</option>
                                        </select>
                                    </div>
