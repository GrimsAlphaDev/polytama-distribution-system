        ...
        <div class="body flex-grow-1">
            <div class="container-lg px-4">
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">Order Request</div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach ($orderRequests as $or)
                                                ...
                                                @elseif ($or->shipment_status_id == 3)
                                                    class="table-info" 
                                                @elseif ($or->shipment_status_id > 3 && $or->shipment_status_id != 11)
                                            class="table-primary"
                                            @elseif ($or->shipment_status_id == 11) class="table-success" @endif>
