    ...
    <div class="container-fluid border-bottom px-4">
        ...
        <ul class="header-nav d-none d-lg-flex">
            <li class="nav-item"><a
                ...
                "
                    href="{{ route('logistik') }}">Dashboard</a></li>
            <li class="nav-item"><a
                    class="nav-link
                {{ request()->is('logistik/firstWeighning') ? 'active' : '' }}
                "
                    href="{{ route('logistik.firstW') }}">Timbangan Pertama</a></li>
            <li class="nav-item"><a
                    class="nav-link
                {{ request()->is('logistik/loadingBarang') ? 'active' : '' }}
                "
                    href="{{ route('logistik.loading.barang') }}">Loading Barang</a></li>
            <li class="nav-item"><a
                    class="nav-link
                {{ request()->is('logistik/secondWeighning') ? 'active' : '' }}
                "
                    href="{{ route('logistik.secondW') }}">Timbangan Kedua</a></li>
